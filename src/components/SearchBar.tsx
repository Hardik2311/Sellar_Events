...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  <div className="flex items-center gap-2">
    ...
    <button
      onClick={onScanClick}
      className="shrink-0 flex items-center justify-center h-11 w-11 rounded-sm bg-[#007A78] hover:bg-[#006361] text-white dark:bg-[#2DD4BF] dark:hover:bg-[#22b8a5] dark:text-slate-950 transition-all shadow-xs active:scale-95"
